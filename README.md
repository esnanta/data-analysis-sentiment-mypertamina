...
Program ini merupakan submission alur belajar **Data Scientist** pada platform **Dicoding** dan bagian dari program **IDCamp 2024 Level Menengah**. Tujuan dari analisis adalah mengetahui **sentimen** menggunakan **klasifikasi teks** untuk mengidentifikasi dan mengevaluasi opini, sikap, atau emosi yang terkandung dalam teks ulasan aplikasi **MyPertamina**.
